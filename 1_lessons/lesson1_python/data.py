...
-m #означает что нужно найти модуль и запустить его как программу. Ффйл - просто документ, а модуль - это файл с кодом, который можно импортировать в другие программы.

-r #означает что нужно использовать файл requirements.txt для установки библиотек. Без -r команда попытается установить модуль requirements.txt как библиотеку.